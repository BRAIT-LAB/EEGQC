...
function [Y_gen, E_gen, ModelDel, flag_out]=data_simulation(DataLength,Trials,ModelDel,SNR,real_samp,sig_num,density,val_Range,AR_perc,AR_choice,popt,forward,sensors_labels,ROI_labels,nyh_path,ft_path,data_path)
...
if forward
    ...
    cd(nyh_path)
    load LF_ICBM152-NY_15002x15.mat;
    load cortex_ICBM152-NY_15002dipoles.mat;
    load pos_15electrodes.mat
...
% cd(data_path);
% save('samp','samp');
EEG = pop_importdata('data',samp,'chanlocs','loc15.xyz','srate',250,'setname','CE');
